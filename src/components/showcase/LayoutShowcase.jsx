...
export default function LayoutShowcase() {
  ...
  return (
    <div className="mb-20">
      <div className="mb-8">
        <h3 className="text-3xl font-black mb-2 text-gray-900 dark:text-white">Layout Components</h3>
        <p className="text-gray-600 dark:text-gray-400">Sidebar navigation and header for dashboard</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Card variant="soft-purple" className="p-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Layout Philosophy</h4>
        ...
        <Card variant="elevated" className="p-8">
          ...
          <div className="border-2 border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden" style={{ height: '600px' }}>
              ...
              <div className="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900">
                ...
                <header className="h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-6">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Folge uns:</span>
                    <div className="flex items-center gap-1.5">
                      <Button size="icon" className="h-8 w-8 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 hover:scale-110 transition-transform">
                  ...
                  {/* Actions */}
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1.5 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-3 py-1.5 rounded-lg text-xs">
                    ...
                    <Button variant="ghost" size="icon" className="h-9 w-9 relative">
                      ...
                      <Badge variant="destructive" className="absolute -top-1 -right-1 h-4 w-4 p-0 flex items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-pink-500 border-0 text-[10px]">
                        3
                      </Badge>
                    </Button>
                ...
                <div className="flex-1 p-6 overflow-auto">
                  <Card className="p-8 text-center">
                    <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Main Content Area</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card variant="elevated" className="p-6">
            <h5 className="font-bold mb-4 text-gray-900 dark:text-white">Sidebar Components</h5>
          ...
          {/* Header Components */}
          <Card variant="elevated" className="p-6">
            <h5 className="font-bold mb-4 text-gray-900 dark:text-white">Header Components</h5>
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              <div className="flex items-center gap-2">
                <Badge variant="secondary">Button</Badge>
        ...
        <Card variant="glass" className="p-6">
          <h5 className="font-bold mb-4 text-gray-900 dark:text-white">Usage in Your App</h5>
          <div className="bg-gray-900 dark:bg-gray-950 rounded-lg p-4 overflow-x-auto">
            <pre className="text-xs text-gray-100 dark:text-gray-200"><code>{`// Create layout components in src/components/layout/
// Then wrap your app:
