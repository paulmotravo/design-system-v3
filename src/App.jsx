...
function ShowcasePage() {
  ...
  return (
    <div className="min-h-screen bg-muted">
      {/* Desktop Navigation */}
      <nav className="hidden lg:block bg-background border-b border-border sticky top-[73px] z-40">
      ...
      {/* Mobile Navigation */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-background border-b border-border sticky top-[73px] z-40">
