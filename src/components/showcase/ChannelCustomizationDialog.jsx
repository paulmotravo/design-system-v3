    ...
    <Card className={`p-6 border-2 ${platformConfig.borderColor} ${platformConfig.bgColor}`}>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h5 className="font-bold text-sm text-foreground">{platformConfig.name}</h5>
            <p className="text-xs text-muted-foreground">{platformConfig.subtext}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-xs text-muted-foreground font-medium min-w-10 text-center">
...
export default function ChannelCustomizationDialog({ open, onOpenChange, channelTexts, onChannelTextsChange }) {
  ...
  const platformConfigs = {
    instagram: {
      ...
      iconBg: 'bg-linear-to-br from-purple-500 via-pink-500 to-orange-500',
    ...
    twitter: {
      ...
      iconBg: 'bg-linear-to-br from-[#1DA1F2] to-[#0d8bd9]',
      borderColor: 'border-blue-200',
      bgColor: 'bg-blue-50/50',
      extraActions: false,
      hasLink: false,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        <Card variant="soft-purple" className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-viralspoon-premium rounded-xl flex items-center justify-center">
