...
export default function ChannelCustomizationShowcase() {
  ...
  const instagramCardCode = `<Card className="p-6 border-2 border-purple-200 dark:border-purple-800 bg-purple-50/50 dark:bg-purple-950/20">
  <div className="flex items-center justify-between mb-4">
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-xs text-gray-600 dark:text-gray-400">Feed Post + Story</p>
      </div>
    </div>
  </div>
  ...
  const facebookCardCode = `<Card className="p-6 border-2 border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/20">
  <div className="flex items-center justify-between mb-4">
    <div className="flex items-center gap-3">
  ...
  const twitterCardCode = `<Card className="p-6 border-2 border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/20">
  <div className="flex items-center justify-between mb-4">
    <div className="flex items-center gap-3">
  ...
  const linkedinCardCode = `<Card className="p-6 border-2 border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/20">
  <div className="flex items-center justify-between mb-4">
    <div className="flex items-center gap-3">
  ...
  return (
    <div className="mb-20">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-3xl font-black mb-2 text-gray-900 dark:text-white">Channel Customization Dialog</h3>
            <p className="text-gray-600 dark:text-gray-400">Platform-specific content adjustments with AI assistance</p>
          </div>
          <Button
      ...
      <div className="space-y-6">
        ...
        <Card variant="soft-purple" className="p-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Channel Customization Philosophy</h4>
          ...
          {showCode ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              <div className="mb-6 text-center">
                ...
                <h5 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Customize Content per Channel</h5>
                            ...
                            <Popover>
                              ...
                              <PopoverContent className="w-80">
                                <div className="space-y-3">
                                  <div>
                                    <div className="text-xs font-semibold mb-2 text-gray-900 dark:text-white">Emojis</div>
                                    <div className="flex flex-wrap gap-1">
                                      {emojis.map((emoji, idx) => (
                                        <Button
                                          ...
                                          variant="ghost"
                                          size="sm"
                                          className="w-8 h-8 p-0 text-base hover:bg-purple-100 dark:hover:bg-purple-900/30"
                                  ...
                                  <Separator />
                                  <div>
                                    <div className="text-xs font-semibold mb-2 text-gray-900 dark:text-white">Special Characters</div>
                                    <div className="flex flex-wrap gap-1">
                                      {specialChars.map((char, idx) => (
                                        <Button
                                          ...
                                          variant="ghost"
                                          size="sm"
                                          className="w-8 h-8 p-0 text-sm hover:bg-purple-100 dark:hover:bg-purple-900/30"
                                    ...
                                    <div className="flex flex-wrap gap-1">
                                      {emojis.map((emoji, idx) => (
                                        <Button
                                          ...
                                          variant="ghost"
                                          size="sm"
                                          className="w-8 h-8 p-0 text-base hover:bg-blue-100 dark:hover:bg-blue-900/30"
                                    ...
                                    <div className="flex flex-wrap gap-1">
                                      {specialChars.map((char, idx) => (
                                        <Button
                                          ...
                                          variant="ghost"
                                          size="sm"
                                          className="w-8 h-8 p-0 text-sm hover:bg-blue-100 dark:hover:bg-blue-900/30"
        ...
        {showCode && (
          <>
            ...
            <Card variant="elevated" className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h4 className="text-sm font-bold text-gray-900 dark:text-white">Instagram Card</h4>
                <Button
                  variant="ghost"
                  size="sm"
