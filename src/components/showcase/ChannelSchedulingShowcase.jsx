...
import { AlertCircle, Calendar, Lock, Code2, Copy, Check } from 'lucide-react'
...
export default function ChannelSchedulingShowcase() {
  ...
  const handleCopy = (section) => {
    const codeMap = {
      ...
      instagram_feed: instagramFeedCardCode,
      instagram_story: instagramStoryCardCode
    }
  ...
  <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
    ...
    {/* 2-Column Grid with platform cards */}
    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Input id="li-date" type="date" className="text-sm" />
        </div>
        <div>
          <Label htmlFor="li-time" className="text-xs mb-2">Time</Label>
          <Input id="li-time" type="time" className="text-sm" />
        </div>
      </div>
    </div>
  )}
    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Input id="ig-feed-date" type="date" className="text-sm" />
        </div>
        <div>
          <Label htmlFor="ig-feed-time" className="text-xs mb-2">Time</Label>
          <Input id="ig-feed-time" type="time" className="text-sm" />
        </div>
      </div>
    </div>
  )}
    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Input id="ig-story-date" type="date" className="text-sm" />
        </div>
        <div>
          <Label htmlFor="ig-story-time" className="text-xs mb-2">Time</Label>
          <Input id="ig-story-time" type="time" className="text-sm" />
        </div>
      </div>
    </div>
  )}
            ...
            <Card variant="elevated" className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => handleCopy('instagram_feed')}
                  className="gap-2"
                >
                  {copiedStates.instagram_feed ? (
                    <>
                      <Check className="w-4 h-4" />
                      Copied!
                    </>
            ...
            <Card variant="elevated" className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => handleCopy('instagram_story')}
                  className="gap-2"
                >
                  {copiedStates.instagram_story ? (
                    <>
                      <Check className="w-4 h-4" />
                      Copied!
                    </>
