	...
	theme: {
	  extend: {
		...
		backgroundImage: {
		  ...
		  'gradient-viral-reverse': 'linear-gradient(135deg, #E77351 0%, #6D6DD8 100%)',
		  'gradient-purple': 'linear-gradient(135deg, #5555B8 0%, #8F8FE8 100%)',
		  'gradient-coral': 'linear-gradient(135deg, #D75531 0%, #FF9471 100%)',
		  'gradient-viralspoon-vibrant': 'linear-gradient(135deg, #8B5CF6 0%, #EC4899 50%, #F97316 100%)',
		},
		borderRadius: {
		  lg: "var(--radius)",
		...
		boxShadow: {
		  ...
		  'glow-viral': '0 0 30px rgba(109, 109, 216, 0.2), 0 0 60px rgba(231, 115, 81, 0.1)',
		},
		animation: {
		...
		keyframes: {
		  ...
		  glow: {
			...
			'to': { boxShadow: '0 0 20px rgba(109, 109, 216, 0.4), 0 0 30px rgba(231, 115, 81, 0.2)' },
		  },
		},
	  },
	},
